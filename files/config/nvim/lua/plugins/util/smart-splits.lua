return {
    {
        ...
        keys = {
            ...
            { '<C-b>h', function() require('smart-splits').swap_buf_left() end },
            { '<C-b>j', function() require('smart-splits').swap_buf_down() end },
            { '<C-b>k', function() require('smart-splits').swap_buf_up() end },
            { '<C-b>l', function() require('smart-splits').swap_buf_right() end },
        },
        opts = {
